    ...
    <div class="header-top">
        <div class="container">
            <div class="logo d-flex">
                <a href="index.html" class="d-flex justify-content-center align-items-center"><h2 > Nusantara<span class="text-primary">Trip</span></h2> <span class="font-weight-bold mx-3 text-xl">-</span> <span style="font-size: 20px">  Dashboard Admin</span></a>
            </div>
