        ...
        <h2 class="text-primaryDarken uppercase mb-2 font-semibold">
            < featured tours</h2>
                <div class="flex text-slate-600 mb-5">
                    ...
                    <p class="mr-2">/ </p><span class="mr-2">{{ $hotelName }}</span>
                </div>
                <div class="w-full bg-white ">
                    <h1 class="text-4xl font-bold mb-5">{{ $hotelName }}</h1>
                ...
                <div class="grid grid-cols-12 gap-4 mb-16">
                    <div class="col-span-7">
                        <div class="w-full bg-white">
                            <div class="mb-2">
                                <p class="link  text-sm">{{$hotelAddress}}</p>
                            </div>
                    ...
                    <div class="col-span-5">
                        <div class="mb-4">
                            <h3 class="text-xl font-semibold mb-1">Rekomendasi Wisata Terdekat dari {{ $hotelName }}</h3>
                            <p><i class="fa-solid fa-location-dot"></i> {{ $hotelRegency }}, {{ $hotelProvince }}</p>
                        </div>
