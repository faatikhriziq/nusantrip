                                    ...
                                    <div class="row mb-3 mt-4">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group ">
                                                <input disabled wire:model="lat" type="text"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group ">
                                                <input disabled wire:model="long" type="text"
                                        ...
                                        <div class="col-6"> <label>Provinsi</label>
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="provinsi"
                                                    wire:model="selectedProvince" wire:click="refresh">
                                        ...
                                        <div class="col-6"><label>Kabupaten</label>
                                            <div class="form-group">
                                                <select class="form-select" aria-label="Default select example"
                                                    id="kabupaten" wire:model="selectedRegency" wire:click="refresh">
